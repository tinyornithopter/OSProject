...
GlobalDescriptorTable::GlobalDescriptorTable()
    : nullSegmentSelector(0, 0, 0),
        ...
        codeSegmentSelector(0, 64*1024*1024, 0x9A),//start at index 0
        dataSegmentSelector(0, 64*1024*1024, 0x92)
{
    uint32_t i[2];
    i[1] = (uint32_t)this;
    i[0] = sizeof(GlobalDescriptorTable) << 16;
    asm volatile("lgdt (%0)": :"p" (((uint8_t *) i)+2));//assembler code tells processor to use this instruction
}
...
uint16_t GlobalDescriptorTable::CodeSegmentSelector()//get offset by taking address of selector and subtracting address of the table
{
